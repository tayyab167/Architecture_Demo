...
{
    public partial class tblLateAllowance
    {
        public tblLateAllowance()
        {
            tblLateAllowanceDetail = new HashSet<tblLateAllowanceDetail>();
        }
        ...
        [InverseProperty("intLateAllowanceNavigation")]
        public virtual ICollection<tblLateAllowanceDetail> tblLateAllowanceDetail { get; set; }
    }
}
